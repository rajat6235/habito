...
export function createApp(): express.Application {
  ...
  // BigInt is not JSON-serializable by default; convert to Number for response payloads.
  // XP values fit safely within Number.MAX_SAFE_INTEGER (9007199254740991).
