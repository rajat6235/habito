  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 pt-32 pb-20">
        {/* Announcement badge */}
        <div className="hero-anim hero-delay-0 flex justify-center mb-8">
        ...
        {/* H1 */}
        <h1 className="hero-anim hero-delay-1 text-5xl sm:text-6xl md:text-7xl font-extrabold leading-[1.1] tracking-tight text-foreground mb-6">
          Build the{' '}
        ...
        {/* Subtitle */}
        <p className="hero-anim hero-delay-2 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          The all-in-one personal operating system for habit tracking, recovery support,
          journaling, and goal achievement.
        </p>

        {/* CTA buttons */}
        <div className="hero-anim hero-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <Link
            href="/register"
        ...
        {/* Stats row */}
        <div className="hero-anim hero-delay-4 inline-flex flex-col sm:flex-row items-center divide-y sm:divide-y-0 sm:divide-x divide-border border border-border rounded-2xl bg-card/50 backdrop-blur-sm overflow-hidden">
          {stats.map((stat) => (
