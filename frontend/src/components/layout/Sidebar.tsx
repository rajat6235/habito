        ...
        <AnimatePresence mode="wait" initial={false}>
          {collapsed ? (
            <motion.span
              ...
              className="text-base font-bold gradient-text mx-auto"
            >
              h
            </motion.span>
          ) : (
            ...
            <AnimatePresence initial={false}>
              {!collapsed && (
                <motion.p
                  ...
                  className="px-3 pb-1.5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground/50 overflow-hidden"
                >
                  {group.label}
                </motion.p>
              )}
      ...
      <div className="px-2 pb-3 space-y-0.5 border-t border-border pt-3 shrink-0">
        ...
        >
          <Tooltip>
            <TooltipTrigger asChild>
              <div
                className="h-8 w-8 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 text-white text-xs font-bold flex items-center justify-center shrink-0 cursor-default"
            ...
            {collapsed && (
              <TooltipContent side="right">{fullName || 'Profile'}</TooltipContent>
            )}
          </Tooltip>
