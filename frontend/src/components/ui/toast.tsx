  ...
  ],
  {
    variants: {
      variant: {
        ...
        success:     'border-emerald-500/30 bg-emerald-50 text-emerald-900 dark:bg-emerald-900/20 dark:text-emerald-100',
        warning:     'border-amber-500/30 bg-amber-50 text-amber-900 dark:bg-amber-900/20 dark:text-amber-100',
      },
    },
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn(
      'ml-auto shrink-0 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground',
